          ...
          >
            {project.featured && (
              <span style={{
                ...
                color: 'var(--teal)', background: 'rgba(91,210,166,0.1)',
            ...
            <h3 style={{
              ...
              fontWeight: 400, color: 'var(--accent)', marginBottom: '0.3rem',
            }}>{project.name}</h3>

            <p style={{
              fontFamily: 'var(--mono)', fontSize: '11px', color: 'var(--teal-dim)',
              letterSpacing: '0.06em', textTransform: 'uppercase', marginBottom: '0.9rem',
            }}>{!project.featured && project.tag + ' · '}{project.period}</p>

            <p style={{
              fontSize: '0.92rem', color: 'var(--text-muted)',
              lineHeight: 1.8, marginBottom: '1.2rem', maxWidth: '750px',
